#!/usr/bin/env node
/**
 * TEST RAPIDE - Vérifie que pty-agent fonctionne
 * 
 * Lancer:
 *   cd pty-agent
 *   npm install
...
console.log('🧪 Test rapide de pty-agent\n');
...
console.log('  import { claude } from "pty-agent";');
console.log('  const ai = await claude();');
